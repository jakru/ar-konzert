package com.qualcomm.vuforia.CloudRecognition.utils;
...
/*See the Vuforia Web Services Developer API Specification - https://developer.vuforia.com/resources/dev-guide/adding-target-cloud-database-api
  This is a Class from the Vuforia Web Services Developer Api.
  No change in this class, they use for the PostNewTarget mechanisms.
*/
